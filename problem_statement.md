...
* To propose a match, I have to do all of above, plus check for multiple dates, so the overall check scales up. 

* I believe my spare time should be spent on building new things, reading and of course playing tennis. So here we go with this project. 

* My plans also include to potentially work with the ladder tournament app builders to integrate such a service to be made available for all users [and there are a lot of them, in lot of cities!]

* The project will also have all my internal docs, bills, etc to serve as my repository where I can ask questions and analyze life! Of course those docs wont be on the public git repo. 